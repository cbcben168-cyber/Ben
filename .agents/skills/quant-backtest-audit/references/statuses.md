...
- `CONDITIONAL_PASS`: A conditional report is allowed; no optimization, promotion, or out-of-sample pass claim is allowed. This is required when no OOS boundary is configured.
